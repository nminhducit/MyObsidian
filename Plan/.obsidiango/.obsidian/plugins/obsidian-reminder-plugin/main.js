    ...
    (function(global2, factory) {
      ...
      function toISOString(keepOffset) {
        ...
        if (m.year() < 0 || m.year() > 9999) {
          return formatMoment(
            m,
            utc ? "DD-MM-YYYYYY[T]HH:mm:ss.SSS[Z]" : "DD-MM-YYYYYY[T]HH:mm:ss.SSSZ"
          );
        }
  ...
  "node_modules/luxon/build/cjs-browser/luxon.js"(exports) {
    ...
    var DateTime5 = /* @__PURE__ */ function() {
      ...
      _proto.toISODate = function toISODate(_temp3) {
        ...
        var fmt = format === "basic" ? "ddMMyyyy" : "dd-MM-yyyy";
        if (this.year > 9999) {
          fmt = "+" + fmt;
        }
      ...
      _proto.toSQLDate = function toSQLDate() {
        return toTechFormat(this, "dd-MM-yyyy");
      };
...
var DateTime = class {
  ...
  static parse(time) {
    if (time.length > 10) {
      return new DateTime((0, import_moment.default)(time, "DD-MM-YYYY HH:mm"), true);
    } else {
      return new DateTime((0, import_moment.default)(time, "DD-MM-YYYY"), false);
    }
  }
  ...
  toYYYYMMDD(defaultTime) {
    return this.fixedTime(defaultTime).format("DD-MM-YYYY");
  }
...
var DateTimeFormatter = class {
  constructor() {
    this.dateFormat = new ConstantReference("DD-MM-YYYY");
    this.dateTimeFormat = new ConstantReference("DD-MM-YYYY HH:mm");
...
TasksPluginReminderModel.dateFormat = "DD-MM-YYYY";
...
var Settings = class {
  constructor() {
    ...
    this.dateFormat = this.settings.newSettingBuilder().key("dateFormat").name("Date format").desc("moment style date format: https://momentjs.com/docs/#/displaying/format/").tag(TAG_RESCAN).text("DD-MM-YYYY").placeHolder("DD-MM-YYYY").onAnyValueChanged((context) => {
    ...
    this.dateTimeFormat = this.settings.newSettingBuilder().key("dateTimeFormat").name("Date and time format").desc("moment() style date time format: https://momentjs.com/docs/#/displaying/format/").tag(TAG_RESCAN).text("DD-MM-YYYY HH:mm").placeHolder("DD-MM-YYYY HH:mm").onAnyValueChanged((context) => {
      context.setEnabled(reminderFormatSettings.enableReminderPluginReminderFormat.value);
    }).build(new RawSerde());
...
function openDateTimeFormatChooser(app, onSelectFormat) {
  new DateTimeFormatModal(app, ["DD-MM-YYYY", "YYYY/MM/DD", "DD-MM-YYYY", "DD/MM/YYYY"], (dateFormat) => {
    new DateTimeFormatModal(app, ["DD-MM-YYYY HH:mm", "YYYY/MM/DD HH:mm", "DD-MM-YYYY HH:mm", "DD/MM/YYYY HH:mm", "DD-MM-YYYYTHH:mm:ss:SSS"], (dateTimeFormat) => {
